...
Part 1. Convert your project 2 list container class to be a template. Populate
...
Note: As long as the finished program meets the requirements of project 3 as a
template, you can modify your project 3 code in any way necessary, including
redesigning your original program (optional).

Part 2. Write an alternative program to meet the requirements for project 2
